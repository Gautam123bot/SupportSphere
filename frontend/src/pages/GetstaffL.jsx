...
import Selectservice_L from "../components/Booking_details/Selectservice_L"
...
function GetstaffL() {
  const navigate = useNavigate();
    ...
    const PageDisplay = () => {
      if (page === 0) {
        return <Selectservice_L data={data} setData={setData}/>
      } else if (page === 1) {
    ...
    return (
      <div className='bg-gradient-to-r from-slate-100 to-red-600 w-full h-screen min-h-full flex flex-col justify-center py-36 sm:px-6 lg:px-8 z-100 mf:h-screen'>
        ...
        <div className='sm:mx-auto sm:w-full sm:max-w-md'>
           ...
           <h1 className='p-4 underline text-center text-cyan-950 text-xl'>Get your Lab Support here</h1>
