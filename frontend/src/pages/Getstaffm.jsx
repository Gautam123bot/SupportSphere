...
import Selectservice_m from "../components/Booking_details/Selectservice_m"
...
function Getstaffm() {
  const navigate = useNavigate();
    ...
    const PageDisplay = () => {
      if (page === 0) {
        return <Selectservice_m data={data} setData={setData}/>
      } else if (page === 1) {
    ...
    return (
      <div className='bg-gradient-to-r from-slate-100 to-red-600 w-full h-screen min-h-full flex flex-col justify-center py-36 sm:px-6 lg:px-8 z-100 mf:h-screen'>
        ...
        <div className='sm:mx-auto sm:w-full sm:max-w-md'>
           ...
           <h1 className='p-4 underline text-center text-cyan-950 text-xl'>Get your Marketing Staff here</h1>
