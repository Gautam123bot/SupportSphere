...
import Selectservice_h from "../components/Booking_details/Selectservice_h";
...
function Getstaffh() {
  ...
  const RegisterUser = async (e) => {
    ...
    try {
      await axios
        .post("https://support-sphere-backend.vercel.app/booked", data)
        // .post("http://localhost:3001/booked", data)
        // username,
        // email,
        // password,
        // firstName,
  ...
  const PageDisplay = () => {
    if (page === 0) {
      return <Selectservice_h data={data} setData={setData} />;
    } else if (page === 1) {
    ...
    <div>
      ...
      <div className="bg-cyan-400 w-full h-screen min-h-full flex flex-col justify-center py-36 sm:px-6 lg:px-8 z-100 mf:h-screen">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <h1 className="p-4 underline text-center text-cyan-950 text-xl">
            Get your Medical Staff here
          </h1>
